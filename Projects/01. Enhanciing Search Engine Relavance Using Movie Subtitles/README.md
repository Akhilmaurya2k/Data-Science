...
* 🗣️ **Accurate Speech-to-Text**: Utilizes OpenAI's Whisper model for high-quality transcription of the recorded dialogues.
* 🧠 **Intelligent Movie/Show Identification**: Employs a sophisticated RAG system. This system uses LangChain, Sentence Transformers for embeddings, and a ChromaDB vector store to find the most relevant movie or TV show based on the transcribed dialogue.
* 🎬 **Detailed Information Output**: Provides the title of the movie/show, its year of release, and, if applicable (for TV series), the season and episode number.
...
## ▶️ Usage (Running the Streamlit App)
...
4.  Click the "🎙️ Record" button to start recording audio. Speak the dialogue you want to identify. Click the button again to stop recording.
